public class CalculadoraFrame extends javax.swing.JFrame {
   ...
   public String operator;
    ...
    private void initComponents() {
        ...
        screen.setBorder(javax.swing.BorderFactory.createMatteBorder(1, 1, 1, 1, new java.awt.Color(204, 0, 204)));
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        .addComponent(screen, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGap(21, 21, 21)
                .addComponent(screen, javax.swing.GroupLayout.PREFERRED_SIZE, 63, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
...
this.screen.setText(this.screen.getText()+"9");
    ...
    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
        ...
        this.numeroA=Float.parseFloat(this.screen.getText());
        this.operator="+";
        this.screen.setText("");
    ...
    private void jButton17ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton17ActionPerformed
        ...
        this.numeroB=Float.parseFloat(this.screen.getText());
        
        switch (this.operator) {  
                case "+":this.screen.setText(Float.toString(this.numeroA+this.numeroB)); break;
                case "-":this.screen.setText(Float.toString(this.numeroA-this.numeroB)); break;
                case "*":this.screen.setText(Float.toString(this.numeroA*this.numeroB)); break;
                case "/":this.screen.setText(Float.toString(this.numeroA/this.numeroB)); break;
